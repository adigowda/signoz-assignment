...
export function EventEditor(props: IEventEditorProps): JSX.Element {
  ...
  return (
    <div className="z-10 absolute top-0 left-0 flex w-full h-screen items-center justify-center">
      <div
        className="bg-[#F0F4F9] border-[#039ae5] border-l-[20px] shadow-2xl flex flex-col gap-6 z-10 p-6 max-w-[420px] rounded-2xl event-editor self-center mx-auto"
        style={{
